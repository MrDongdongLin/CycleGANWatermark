...
parser.add_argument(
    ...
    default="D:\\Deepfake\\Methods\\ArtificialGANFingerprints\\encoder\\CelebA_128x128_encoder.pth"
)
parser.add_argument(
    "--data_dir", type=str, help="Directory with images.",
    default="D:\\Deepfake\\Datasets\\AgingFace\\train\\A"
)
parser.add_argument(
    "--output_dir", type=str, help="Path to save watermarked images to.",
    default="D:\\Deepfake\\Datasets\\AgingFace\\train\\Aw"
)
parser.add_argument(
...
parser.add_argument(
    "--decoder_path", type=str, help="Provide trained StegaStamp decoder to verify fingerprint detection accuracy.",
    default="D:\\Deepfake\\Methods\\ArtificialGANFingerprints\\decoder\\CelebA_128x128_decoder.pth"
)
...
def embed_fingerprints():
    ...
    if args.check:
        ...
        save_image(fingerprinted_images[:49], os.path.join(args.output_dir, "test_samples_watermarked.png"), nrow=7)
