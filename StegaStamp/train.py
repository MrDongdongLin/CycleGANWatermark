...
parser.add_argument(
    "--data_dir", type=str, help="Directory with image dataset.",
    default="D:\\Deepfake\\Datasets\\CelebA\\img_align_celeba_jpg"
)
parser.add_argument(
...
parser.add_argument(
    "--output_dir", type=str, help="Directory to save results to.",
    default="D:\\Deepfake\\Methods\\ArtificialGANFingerprints"
)
parser.add_argument(
    "--fingerprint_length",
    type=int,
...
plot_points = (
        list(range(0, 1000, 100))  # 11
        + list(range(1000, 3000, 200))  # 11
        + list(range(3000, 100000, 1000))  # 98
)
...
def load_data():
    ...
    global IMAGE_CHANNELS, IMAGE_HEIGHT, IMAGE_WIDTH, SECRET_SIZE, WATERMARK_UPSIZE
    ...
    if args.use_celeba_preprocessing:
        ...
        #     ]
        # )
        transform = get_transform(args, grayscale=(IMAGE_CHANNELS == 1), convert=True)
    else:
